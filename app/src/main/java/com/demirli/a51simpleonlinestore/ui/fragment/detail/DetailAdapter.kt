...
class DetailAdapter(var context: Context, var productList: List<Product>, var listOfCartDetail: List<CartDetail>): RecyclerView.Adapter<DetailAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.quantity.setText("Quantity: " + listOfCartDetail[position].quantity.toString())
